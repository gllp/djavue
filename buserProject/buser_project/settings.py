"""
Django settings for buser_project project.
...
ROOT_URLCONF = 'buser_project.urls'
...
WSGI_APPLICATION = 'buser_project.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './buser_project.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
